package com.msujayappdev.simplecalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void plusMinusBTN(View view){
        ...
        if(display.getText().toString().charAt(0)!='-'){
            display.setText(String.format("%s%s", res, display.getText().toString()));
            display.setSelection(cursorPos+1);
        }
        else if (display.getText().toString().charAt(0)=='-'){
            res=display.getText().toString().substring(1, textLen);
            display.setText(res);
    ...
    public void bracketBTN(View view){
        ...
        if(leftBracket==rightBracket || display.getText().toString().charAt(textLen - 1) == '('){
            updateText("(");
        }
        else if(leftBracket>rightBracket && display.getText().toString().charAt(textLen - 1) != '('){
            updateText(")");
        }
        display.setSelection(cursorPos+1);
    }
